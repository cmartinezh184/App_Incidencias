...
public class AgregarIncidenciaActivity extends AppCompatActivity implements OnMapReadyCallback, AdapterView.OnItemSelectedListener{

    private Button btnRegistrarIncidencia, btnElegirFoto;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SpinnerCantonLI=(Spinner) findViewById(R.id.Canton_Registrar);
        SpinnerCantonGUA=(Spinner) findViewById(R.id.Canton_Registrar);
        SpinnerCantonPUN=(Spinner) findViewById(R.id.Canton_Registrar);
